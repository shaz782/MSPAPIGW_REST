...
public class ReActivateAccountResponse extends CommonResponse{
	...
	public String toString() {
		return "ReActivateAccountResponse [tarnsationID=" + tarnsationID + ", tarnsationRefNo=" + tarnsationRefNo + "]";
	}
