...
public class SubscriberManagementAgentInvoker {
	...
	public GetMsisdnbasedATPDtlsResponse getMsisdnbasedATPDtls(GetMsisdnbasedATPDtlsRequest agentRequest, CommonHeaders headers)
			throws MSPAPIGWExceptions  {
	...
	public GetMsisdnAttachedATPDtlsResponse getMsisdnAttachedATPDtls(GetMsisdnAttachedATPDtlsRequest agentRequest, CommonHeaders headers)
			throws MSPAPIGWExceptions  {
	...
	public GetCommercialSimFlagResponse checkCommercialSIM(GetCommercialSimFlagRequest agentRequest, CommonHeaders headers)
			throws MSPAPIGWExceptions  {
