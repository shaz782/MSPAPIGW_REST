...
public class ATPSubscriptionResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the transId value for this ATPSubscriptionResponse.
     * 
     * @return transId
     */
    ...
    /**
     * Sets the transId value for this ATPSubscriptionResponse.
     * 
     * @param transId
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://smf.agent.xius.com/SMFManagement.xsd", "ATPSubscriptionResponse"));
