...
public class ChangeTPResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the transId value for this ChangeTPResponse.
     * 
     * @return transId
     */
    ...
    /**
     * Sets the transId value for this ChangeTPResponse.
     * 
     * @param transId
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://smf.agent.xius.com/SMFManagement.xsd", "changeTPResponse"));
