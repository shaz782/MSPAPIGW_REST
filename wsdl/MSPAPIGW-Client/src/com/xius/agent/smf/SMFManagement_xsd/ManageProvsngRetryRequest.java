...
public class ManageProvsngRetryRequest  implements java.io.Serializable {
    private com.xius.agent.smf.SMFManagement_xsd.ManageProvsngRetry manageProvsngRetryType;

    public ManageProvsngRetryRequest() {
    }

    public ManageProvsngRetryRequest(
           com.xius.agent.smf.SMFManagement_xsd.ManageProvsngRetry manageProvsngRetryType) {
     ...
     */
    public com.xius.agent.smf.SMFManagement_xsd.ManageProvsngRetry getManageProvsngRetryType() {
        return manageProvsngRetryType;
    }
     ...
     */
    public void setManageProvsngRetryType(com.xius.agent.smf.SMFManagement_xsd.ManageProvsngRetry manageProvsngRetryType) {
        this.manageProvsngRetryType = manageProvsngRetryType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://smf.agent.xius.com/SMFManagement.xsd", "ManageProvsngRetryRequest"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("manageProvsngRetryType");
        elemField.setXmlName(new javax.xml.namespace.QName("http://smf.agent.xius.com/SMFManagement.xsd", "manageProvsngRetryType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://smf.agent.xius.com/SMFManagement.xsd", "ManageProvsngRetry"));
