...
public class SimRegistrationResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the transId value for this SimRegistrationResponse.
     * 
     * @return transId
     */
    ...
    /**
     * Sets the transId value for this SimRegistrationResponse.
     * 
     * @param transId
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://smf.agent.xius.com/SMFManagement.xsd", "SimRegistrationResponse"));
