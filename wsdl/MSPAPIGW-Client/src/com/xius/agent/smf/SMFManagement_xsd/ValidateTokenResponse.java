...
public class ValidateTokenResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the message value for this ValidateTokenResponse.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this ValidateTokenResponse.
     * 
     * @param message
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://smf.agent.xius.com/SMFManagement.xsd", "validateTokenResponse"));
