...
public class AccountServiceLocator extends org.apache.axis.client.Service implements com.xius.msp.billing.client.accountManagement.AccountService {
    ...
    public com.xius.msp.billing.client.accountManagement.AccountManagementPortType getAccountManagementPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.xius.msp.billing.client.accountManagement.AccountManagementPortType getAccountManagementPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.xius.msp.billing.client.accountManagement.AccountManagementBindingStub _stub = new com.xius.msp.billing.client.accountManagement.AccountManagementBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.xius.msp.billing.client.accountManagement.AccountManagementPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.xius.msp.billing.client.accountManagement.AccountManagementBindingStub _stub = new com.xius.msp.billing.client.accountManagement.AccountManagementBindingStub(new java.net.URL(AccountManagementPort_address), this);
                _stub.setPortName(getAccountManagementPortWSDDServiceName());
                return _stub;
            }
        }
