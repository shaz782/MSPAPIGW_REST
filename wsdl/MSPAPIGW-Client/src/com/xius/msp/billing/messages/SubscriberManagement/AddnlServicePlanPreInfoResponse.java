/**
 * AddnlServicePlanPreInfoResponse.java
 *
...
public class AddnlServicePlanPreInfoResponse  implements java.io.Serializable {
    private com.xius.msp.billing.messages.SubscriberManagement.ServicePlanType[] servicePlansList;

    public AddnlServicePlanPreInfoResponse() {
    }
    ...
    /**
     * Gets the servicePlansList value for this AddnlServicePlanPreInfoResponse.
     * 
    ...
    /**
     * Sets the servicePlansList value for this AddnlServicePlanPreInfoResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AddnlServicePlanPreInfoResponse)) return false;
        AddnlServicePlanPreInfoResponse other = (AddnlServicePlanPreInfoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AddnlServicePlanPreInfoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://billing.xius.com/SubscriberManagement.xsd", "AddnlServicePlanPreInfoResponse"));
