...
public class GetBndlBucketsRequest  implements java.io.Serializable {
    private com.xius.msp.billing.messages.SubscriberManagement.AccountType account;

    public GetBndlBucketsRequest() {
    }
    ...
    /**
     * Gets the account value for this GetBndlBucketsRequest.
     * 
     * @return account
     */
    ...
    /**
     * Sets the account value for this GetBndlBucketsRequest.
     * 
     * @param account
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetBndlBucketsRequest)) return false;
        GetBndlBucketsRequest other = (GetBndlBucketsRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetBndlBucketsRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://billing.xius.com/SubscriberManagement.xsd", "GetBndlBucketsRequest"));
