...
public class GetDeviceInfoRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the account value for this GetDeviceInfoRequest.
     * 
     * @return account
     */
    ...
    /**
     * Sets the account value for this GetDeviceInfoRequest.
     * 
     * @param account
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetDeviceInfoRequest)) return false;
        GetDeviceInfoRequest other = (GetDeviceInfoRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetDeviceInfoRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://billing.xius.com/SubscriberManagement.xsd", "GetDeviceInfoRequest"));
