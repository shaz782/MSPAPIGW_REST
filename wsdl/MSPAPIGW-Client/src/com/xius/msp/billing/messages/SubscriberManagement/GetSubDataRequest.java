...
public class GetSubDataRequest  implements java.io.Serializable {
    private com.xius.msp.billing.messages.SubscriberManagement.AccountType account;

    public GetSubDataRequest() {
    }
    ...
    /**
     * Gets the account value for this GetSubDataRequest.
     * 
     * @return account
     */
    ...
    /**
     * Sets the account value for this GetSubDataRequest.
     * 
     * @param account
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetSubDataRequest)) return false;
        GetSubDataRequest other = (GetSubDataRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetSubDataRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://billing.xius.com/SubscriberManagement.xsd", "GetSubDataRequest"));
