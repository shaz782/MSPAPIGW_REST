...
public class GetSubViewDataRequest  implements java.io.Serializable {
    private com.xius.msp.billing.messages.SubscriberManagement.AccountType account;

    public GetSubViewDataRequest() {
    }
    ...
    /**
     * Gets the account value for this GetSubViewDataRequest.
     * 
     * @return account
     */
    ...
    /**
     * Sets the account value for this GetSubViewDataRequest.
     * 
     * @param account
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetSubViewDataRequest)) return false;
        GetSubViewDataRequest other = (GetSubViewDataRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetSubViewDataRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://billing.xius.com/SubscriberManagement.xsd", "GetSubViewDataRequest"));
