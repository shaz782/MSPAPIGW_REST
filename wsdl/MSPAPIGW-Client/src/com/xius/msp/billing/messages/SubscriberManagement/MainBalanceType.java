...
public class MainBalanceType  implements java.io.Serializable {
    ...
    /**
     * Gets the balance value for this MainBalanceType.
     * 
     * @return balance
     */
    ...
    /**
     * Sets the balance value for this MainBalanceType.
     * 
     * @param balance
     */
    ...
    /**
     * Gets the validity value for this MainBalanceType.
     * 
     * @return validity
     */
    ...
    /**
     * Sets the validity value for this MainBalanceType.
     * 
     * @param validity
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://billing.xius.com/SubscriberManagement.xsd", "MainBalanceType"));
