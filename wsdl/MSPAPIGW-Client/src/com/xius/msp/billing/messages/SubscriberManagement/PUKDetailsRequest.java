...
public class PUKDetailsRequest  implements java.io.Serializable {
    private com.xius.msp.billing.messages.SubscriberManagement.AccountType account;

    public PUKDetailsRequest() {
    }
    ...
    /**
     * Gets the account value for this PUKDetailsRequest.
     * 
     * @return account
     */
    ...
    /**
     * Sets the account value for this PUKDetailsRequest.
     * 
     * @param account
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PUKDetailsRequest)) return false;
        PUKDetailsRequest other = (PUKDetailsRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PUKDetailsRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://billing.xius.com/SubscriberManagement.xsd", "PUKDetailsRequest"));
