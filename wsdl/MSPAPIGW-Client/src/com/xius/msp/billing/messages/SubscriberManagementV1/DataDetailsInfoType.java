...
public class DataDetailsInfoType  implements java.io.Serializable {
    ...
    private java.lang.String ratingGroup;

    public DataDetailsInfoType() {
    }
    ...
    /**
     * Gets the bucketName value for this DataDetailsInfoType.
     * 
     * @return bucketName
     */
    ...
    /**
     * Sets the bucketName value for this DataDetailsInfoType.
     * 
     * @param bucketName
     */
    ...
    /**
     * Gets the unitsAllocated value for this DataDetailsInfoType.
     * 
    ...
    /**
     * Sets the unitsAllocated value for this DataDetailsInfoType.
     * 
    ...
    /**
     * Gets the remainingUnits value for this DataDetailsInfoType.
     * 
    ...
    /**
     * Sets the remainingUnits value for this DataDetailsInfoType.
     * 
    ...
    /**
     * Gets the unitsType value for this DataDetailsInfoType.
     * 
     * @return unitsType
     */
    ...
    /**
     * Sets the unitsType value for this DataDetailsInfoType.
     * 
     * @param unitsType
     */
    ...
    /**
     * Gets the ratingGroup value for this DataDetailsInfoType.
     * 
     * @return ratingGroup
     */
    public java.lang.String getRatingGroup() {
        return ratingGroup;
    }


    /**
     * Sets the ratingGroup value for this DataDetailsInfoType.
     * 
     * @param ratingGroup
     */
    public void setRatingGroup(java.lang.String ratingGroup) {
        this.ratingGroup = ratingGroup;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DataDetailsInfoType)) return false;
        DataDetailsInfoType other = (DataDetailsInfoType) obj;
        ...
        _equals = true && 
            ...
            ((this.ratingGroup==null && other.getRatingGroup()==null) || 
             (this.ratingGroup!=null &&
              this.ratingGroup.equals(other.getRatingGroup())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getRatingGroup() != null) {
            _hashCode += getRatingGroup().hashCode();
        }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DataDetailsInfoType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://billing.xius.com/SubscriberManagementV1.xsd", "dataDetailsInfoType"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("ratingGroup");
        elemField.setXmlName(new javax.xml.namespace.QName("http://billing.xius.com/SubscriberManagementV1.xsd", "ratingGroup"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
