...
public class ServiceType implements java.io.Serializable {
    ...
    public static final java.lang.String _TUNEBUDDIES = "TUNEBUDDIES";
    public static final java.lang.String _VIDEO = "VIDEO";
    public static final ServiceType VOICE = new ServiceType(_VOICE);
    public static final ServiceType SMS = new ServiceType(_SMS);
    public static final ServiceType DATA = new ServiceType(_DATA);
    public static final ServiceType TUNEBUDDIES = new ServiceType(_TUNEBUDDIES);
    public static final ServiceType VIDEO = new ServiceType(_VIDEO);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://billing.xius.com/ReportManagement.xsd", "ServiceType"));
    }
    /**
