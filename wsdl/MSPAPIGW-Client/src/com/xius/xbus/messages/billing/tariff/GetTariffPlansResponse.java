...
public class GetTariffPlansResponse  extends com.xius.xbus.messages.common.WSResponse  implements java.io.Serializable {
    private java.lang.String accountID;

    private java.lang.String currentTariffPlanName;

    private com.xius.xbus.messages.billing.tariff.TarrifPlanInfoType currentTariffPlan;

    private com.xius.xbus.messages.billing.tariff.TarrifPlanInfoType[] availableTariffPlans;

    private java.math.BigDecimal charge;

    public GetTariffPlansResponse() {
    }
    ...
    public GetTariffPlansResponse(
           ...
           com.xius.xbus.messages.billing.tariff.TarrifPlanInfoType currentTariffPlan,
           com.xius.xbus.messages.billing.tariff.TarrifPlanInfoType[] availableTariffPlans,
    ...
    /**
     * Gets the accountID value for this GetTariffPlansResponse.
     * 
     * @return accountID
     */
    ...
    /**
     * Sets the accountID value for this GetTariffPlansResponse.
     * 
     * @param accountID
     */
    ...
    /**
     * Gets the currentTariffPlanName value for this GetTariffPlansResponse.
     * 
    ...
    /**
     * Sets the currentTariffPlanName value for this GetTariffPlansResponse.
     * 
    ...
    /**
     * Gets the currentTariffPlan value for this GetTariffPlansResponse.
     * 
     * @return currentTariffPlan
     */
    public com.xius.xbus.messages.billing.tariff.TarrifPlanInfoType getCurrentTariffPlan() {
        return currentTariffPlan;
    }


    /**
     * Sets the currentTariffPlan value for this GetTariffPlansResponse.
     * 
     * @param currentTariffPlan
     */
    public void setCurrentTariffPlan(com.xius.xbus.messages.billing.tariff.TarrifPlanInfoType currentTariffPlan) {
        this.currentTariffPlan = currentTariffPlan;
    }


    /**
     * Gets the availableTariffPlans value for this GetTariffPlansResponse.
     * 
     * @return availableTariffPlans
     */
    public com.xius.xbus.messages.billing.tariff.TarrifPlanInfoType[] getAvailableTariffPlans() {
        return availableTariffPlans;
    }


    /**
     * Sets the availableTariffPlans value for this GetTariffPlansResponse.
     * 
     * @param availableTariffPlans
     */
    public void setAvailableTariffPlans(com.xius.xbus.messages.billing.tariff.TarrifPlanInfoType[] availableTariffPlans) {
        this.availableTariffPlans = availableTariffPlans;
    }

    public com.xius.xbus.messages.billing.tariff.TarrifPlanInfoType getAvailableTariffPlans(int i) {
        return this.availableTariffPlans[i];
    }

    public void setAvailableTariffPlans(int i, com.xius.xbus.messages.billing.tariff.TarrifPlanInfoType _value) {
        this.availableTariffPlans[i] = _value;
    }


    /**
     * Gets the charge value for this GetTariffPlansResponse.
     * 
     * @return charge
     */
    ...
    /**
     * Sets the charge value for this GetTariffPlansResponse.
     * 
     * @param charge
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetTariffPlansResponse)) return false;
        GetTariffPlansResponse other = (GetTariffPlansResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetTariffPlansResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xbus.xius.com/messages/billing/tariff", ">getTariffPlansResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://xbus.xius.com/messages/billing/tariff", "TarrifPlanInfoType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
