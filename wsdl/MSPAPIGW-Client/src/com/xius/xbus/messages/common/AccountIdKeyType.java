...
public class AccountIdKeyType implements java.io.Serializable {
    ...
    public static final java.lang.String _SIM = "SIM";
    public static final java.lang.String _IMSI = "IMSI";
    public static final AccountIdKeyType MSISDN = new AccountIdKeyType(_MSISDN);
    public static final AccountIdKeyType SIM = new AccountIdKeyType(_SIM);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xbus.xius.com/messages/common", "AccountIdKeyType"));
    }
    /**
