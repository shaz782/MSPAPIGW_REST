...
public class AccountStatusType implements java.io.Serializable {
    ...
    public static final java.lang.String _GRACE_PERIOD_ONE = "GRACE_PERIOD_ONE";
    public static final java.lang.String _GRACE_PERIOD_TWO = "GRACE_PERIOD_TWO";
    public static final AccountStatusType ACTIVE = new AccountStatusType(_ACTIVE);
    public static final AccountStatusType LOCKED = new AccountStatusType(_LOCKED);
    public static final AccountStatusType EXPIRED = new AccountStatusType(_EXPIRED);
    public static final AccountStatusType DEACTIVE = new AccountStatusType(_DEACTIVE);
    public static final AccountStatusType PENDING = new AccountStatusType(_PENDING);
    public static final AccountStatusType SUBMITTED = new AccountStatusType(_SUBMITTED);
    public static final AccountStatusType TRANSIT = new AccountStatusType(_TRANSIT);
    public static final AccountStatusType GRACE_PERIOD_ONE = new AccountStatusType(_GRACE_PERIOD_ONE);
    public static final AccountStatusType GRACE_PERIOD_TWO = new AccountStatusType(_GRACE_PERIOD_TWO);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xbus.xius.com/messages/common", "AccountStatusType"));
    }
    /**
