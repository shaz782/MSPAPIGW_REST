...
public class ActionFlagType implements java.io.Serializable {
    ...
    public static final ActionFlagType ADD = new ActionFlagType(_ADD);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xbus.xius.com/messages/common", "ActionFlagType"));
    }
    /**
