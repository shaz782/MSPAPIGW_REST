...
public class ActionType implements java.io.Serializable {
    ...
    public static final ActionType MODIFY = new ActionType(_MODIFY);
    public static final ActionType DELETE = new ActionType(_DELETE);
    public static final ActionType VIEW = new ActionType(_VIEW);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xbus.xius.com/messages/common", "ActionType"));
    }
    /**
