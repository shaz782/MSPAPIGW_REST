...
public class PersonalIdentityType implements java.io.Serializable {
    ...
    public static final PersonalIdentityType PASSPORT = new PersonalIdentityType(_PASSPORT);
    public static final PersonalIdentityType MYKAD = new PersonalIdentityType(_MYKAD);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xbus.xius.com/messages/common", "PersonalIdentityType"));
    }
    /**
