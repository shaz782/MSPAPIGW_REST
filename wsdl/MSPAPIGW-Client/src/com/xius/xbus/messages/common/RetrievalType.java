...
public class RetrievalType implements java.io.Serializable {
    ...
    public static final RetrievalType LATEST_THREE = new RetrievalType(_LATEST_THREE);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xbus.xius.com/messages/common", "RetrievalType"));
    }
    /**
