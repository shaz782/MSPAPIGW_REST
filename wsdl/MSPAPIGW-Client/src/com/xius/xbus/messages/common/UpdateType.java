...
public class UpdateType implements java.io.Serializable {
    ...
    public static final UpdateType ADD = new UpdateType(_ADD);
    public static final UpdateType MODIFY = new UpdateType(_MODIFY);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xbus.xius.com/messages/common", "UpdateType"));
    }
    /**
