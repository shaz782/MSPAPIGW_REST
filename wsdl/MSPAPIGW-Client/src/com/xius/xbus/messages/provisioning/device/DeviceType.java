...
public class DeviceType implements java.io.Serializable {
    ...
    public static final DeviceType SIM = new DeviceType(_SIM);
    public static final DeviceType IMSI = new DeviceType(_IMSI);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xbus.xius.com/messages/provisioning/device", "DeviceType"));
    }
    /**
