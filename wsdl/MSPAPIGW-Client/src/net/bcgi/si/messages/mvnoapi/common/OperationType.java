...
public class OperationType implements java.io.Serializable {
    ...
    public static final OperationType CREATE = new OperationType(_CREATE);
    public static final OperationType UPDATE = new OperationType(_UPDATE);
    public static final OperationType DELETE = new OperationType(_DELETE);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://common.mvnoapi.messages.si.bcgi.net", "OperationType"));
    }
    /**
