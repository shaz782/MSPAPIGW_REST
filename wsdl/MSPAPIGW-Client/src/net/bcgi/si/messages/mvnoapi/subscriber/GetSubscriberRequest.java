...
public class GetSubscriberRequest  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    private net.bcgi.si.messages.mvnoapi.subscriber.SubscriberIdKey subscriberId;
    ...
    public GetSubscriberRequest(
           ...
           net.bcgi.si.messages.mvnoapi.subscriber.SubscriberIdKey subscriberId,
    ...
    /**
     * Gets the messageID value for this GetSubscriberRequest.
     * 
     * @return messageID
     */
    ...
    /**
     * Sets the messageID value for this GetSubscriberRequest.
     * 
     * @param messageID
     */
    ...
    /**
     * Gets the securityId value for this GetSubscriberRequest.
     * 
     * @return securityId
     */
    ...
    /**
     * Sets the securityId value for this GetSubscriberRequest.
     * 
     * @param securityId
     */
    ...
    /**
     * Gets the serviceContext value for this GetSubscriberRequest.
     * 
    ...
    /**
     * Sets the serviceContext value for this GetSubscriberRequest.
     * 
    ...
    /**
     * Gets the subscriberId value for this GetSubscriberRequest.
     * 
     * @return subscriberId
     */
    public net.bcgi.si.messages.mvnoapi.subscriber.SubscriberIdKey getSubscriberId() {
        return subscriberId;
    }


    /**
     * Sets the subscriberId value for this GetSubscriberRequest.
     * 
     * @param subscriberId
     */
    public void setSubscriberId(net.bcgi.si.messages.mvnoapi.subscriber.SubscriberIdKey subscriberId) {
        this.subscriberId = subscriberId;
    }


    /**
     * Gets the version value for this GetSubscriberRequest.
     * 
     * @return version
     */
    ...
    /**
     * Sets the version value for this GetSubscriberRequest.
     * 
     * @param version
     */
    ...
    /**
     * Gets the _any value for this GetSubscriberRequest.
     * 
     * @return _any
     */
    ...
    /**
     * Sets the _any value for this GetSubscriberRequest.
     * 
     * @param _any
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://subscriber.mvnoapi.messages.si.bcgi.net", "GetSubscriberRequest"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://subscriber.mvnoapi.messages.si.bcgi.net", "subscriberId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://subscriber.mvnoapi.messages.si.bcgi.net", "SubscriberIdKey"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
