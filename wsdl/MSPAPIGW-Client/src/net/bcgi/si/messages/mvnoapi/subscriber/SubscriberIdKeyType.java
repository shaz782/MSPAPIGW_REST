...
public class SubscriberIdKeyType implements java.io.Serializable {
    ...
    public static final SubscriberIdKeyType MDN = new SubscriberIdKeyType(_MDN);
    public static final SubscriberIdKeyType ACCOUNT_ID = new SubscriberIdKeyType(_ACCOUNT_ID);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://subscriber.mvnoapi.messages.si.bcgi.net", "SubscriberIdKeyType"));
    }
    /**
